...
class QWEN_Model:
    ...
    def __call__(self, conversation: list, images:list[str]=None, debug: bool=False, batch_size: int=None, max_new_tokens=None) -> list:
        """
        ...
        """
        # Set the batch size and max_new_tokens if provided
        ...
        if images is None:
            ...
            text_prompts = [text_prompt] * (self.batch_size if not batch_size else batch_size)
